...
if("TRUE" STREQUAL "TRUE")
  set(exercise3_SOURCE_PREFIX /work/catkin_ws/src/exercise3)
  set(exercise3_DEVEL_PREFIX /work/catkin_ws/devel)
  ...
  set(exercise3_INSTALL_PREFIX /work/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'exercise3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'w043 <w043@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'exercise3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/work/catkin_ws/src/exercise3/${idir}'.  Ask the maintainer 'w043 <w043@todo.todo>' to fix it.")
    endif()
